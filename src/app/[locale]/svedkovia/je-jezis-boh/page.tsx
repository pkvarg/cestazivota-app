...
export default async function JezisPage() {
  ...
  return (
    <div>
      ...
      <section className="bg-[#6dc3dd] py-8 px-4 lg:px-[5%] verse-sv text-[14px] lg:text-[18px]">
        <div className="text-black leading-[18px] lg:leading-[28px]">
          <p className="my-4">{t.jText1}</p>

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub2}</h2>
          ...
          {t.jSub3 && <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub3}</h2>}
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub6_5}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub7}</h2>
          <Verse text={t.jVerse9} reference={t.jRef9} />
          <Verse text={t.jVerse10} reference={t.jRef10} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub8}</h2>
          <Verse text={t.jVerse11} reference={t.jRef11} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub9}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub10}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.jSub12}</h2>
