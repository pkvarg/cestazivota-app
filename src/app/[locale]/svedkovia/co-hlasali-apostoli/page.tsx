...
export default async function ApostoliPage() {
  ...
  return (
    <div>
      ...
      <section className="bg-[#895f11] py-8 px-4 lg:px-[5%] verse-sv text-[14px] lg:text-[18px]">
        <div className="text-stone-100 leading-[18px] lg:leading-[28px]">
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub1}</h2>
          <Verse text={t.apVerse1} reference={t.apRef1} />
          <Verse text={t.apVerse2} reference={t.apRef2} />
          <p className="my-4">{t.apText1}</p>

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub2}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub3}</h2>
          <Verse text={t.apVerse11} reference={t.apRef11} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub4}</h2>
          <Verse text={t.apVerse12} reference={t.apRef12} />
          <Verse text={t.apVerse13} reference={t.apRef13} />
          <p className="my-4">{t.apText3}</p>

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub5}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub6}</h2>
          <p className="my-4">{t.apText6}</p>
          <Verse text={t.apVerse17} reference={t.apRef17} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub7}</h2>
          <Verse text={t.apVerse18} reference={t.apRef18} />
          <p className="my-4">{t.apText7}</p>

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub8}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.apSub9}</h2>
