...
export default async function VeceraPage() {
  ...
  return (
    <div>
      ...
      <section className="bg-[#8e562d] py-8 px-4 lg:px-[5%] verse-sv text-[14px] lg:text-[18px]">
        <div className="text-stone-100 leading-[18px] lg:leading-[28px]">
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub1}</h2>
          <Verse text={t.sVerse1} reference={t.sRef1} />
          <p className="my-4">{t.sText1}</p>
          <Verse text={t.sVerse2} reference={t.sRef2} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub2}</h2>
          <Verse text={t.sVerse3} reference={t.sRef3} />
          <p className="my-4">{t.sText2}</p>
          <Verse text={t.sVerse4} reference={t.sRef4} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub3}</h2>
          <Verse text={t.sVerse5} reference={t.sRef5} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub4}</h2>
          <Verse text={t.sVerse6} reference={t.sRef6} />

          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub5}</h2>
          ...
          <h2 className="text-[18px] lg:text-[24px] font-medium mt-8 mb-4 text-center">{t.sSub6}</h2>
